...
CREATE TABLE `homeless` (
	...
	CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT FK_HOMELESS_HOMELESS_DATAIL FOREIGN KEY(ID_HOMELESS_INFO) REFERENCES HOMELESS_INFO(ID),
...
CREATE TABLE `meeting_point_organization` (
    ...
    UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY(ID),
    CONSTRAINT FK_MEETING_POINT_ORGANIZATION_HOMELESS FOREIGN KEY(ID_HOMELESS) REFERENCES HOMELESS(ID),
    CONSTRAINT FK_MEETING_POINT_ORGANIZATION_ORGANIZATION FOREIGN KEY(ID_ORGANIZATION) REFERENCES `ORGANIZATION`(ID)
);
